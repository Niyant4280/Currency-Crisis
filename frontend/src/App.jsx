...
function App() {
  ...
  // This silently pings /api/status so the cold-start begins immediately,
  // giving the backend a head-start before the user navigates to the dashboard.
  useEffect(() => {
    pingBackend().catch(() => {/* silently ignore — waking panels handle UX */});
  }, []);
